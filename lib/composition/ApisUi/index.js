...
import { Center, Box, Stack, VStack, Button, InputGroup, Input, InputRightElement } from "@chakra-ui/react";
...
export default function Index(props) {
  ...
  function searchApiList(searchValue) {
    setIsLoading(true); //通过apiName获取API路径
  ...
  return /*#__PURE__*/React.createElement(VStack, {
    ...
    spacing: "10px",
    align: "center"
  }, isShowList && /*#__PURE__*/React.createElement(InputGroup, {
    size: "md"
    ...
    onClick: () => goBack()
  }, "\u8FD4\u56DE"), isShowData && showApiDetail && /*#__PURE__*/React.createElement(Button, {
    w: "100px",
    h: "35px",
    colorScheme: "facebook",
    onClick: () => getApiDetail()
  }, "\u67E5\u770BAPI"), /*#__PURE__*/React.createElement(Center, null, /*#__PURE__*/React.createElement(Button, {
    w: "35px",
    h: "35px",
    borderRadius: "4px",
    padding: "9px",
  ...
  }) : isShowList ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(AutoLayout, _extends({}, config, {
    onItemClick: onApiItemClick,
    onItemDeleted: onDelAction

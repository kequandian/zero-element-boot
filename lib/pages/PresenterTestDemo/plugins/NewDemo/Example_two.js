import React from 'react'; // import BigBox from '@/plugins/NewDemo/BigBox';
...
export default function ExampleComment(props) {
  ...
  return /*#__PURE__*/React.createElement(AutoLayout, config, /*#__PURE__*/React.createElement(ExampleTwo, null));
}
...
const {
  Container
} = require("../container"); // const { CloneAutoLayout } = require('@/components/CloneAutoLayout');
//change history
  ...
  return /*#__PURE__*/React.createElement(_Container, _extends({}, _container, data, {
    ...
    if (typeof presenter === 'string') {
      ...
      return /*#__PURE__*/React.createElement(NamedGateway, _extends({}, _gateway, {
        key: i,
        span: span
      }), presenter ? /*#__PURE__*/React.createElement("div", null, "\u5F15\u7528CloneAutoLayout") : React.Children.toArray(children));
    }
  }) : React.Children.map(children, (child, i) => {
    return cart ? /*#__PURE__*/React.createElement(NamedCart, _extends({
      key: i

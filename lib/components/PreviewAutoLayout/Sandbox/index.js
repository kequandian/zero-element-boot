...
import qs from 'qs'; // const promiseAjax = require('@/components/utils/request');

import PreviewAutoLayout from "../index";
import PreviewItem from "./PreviewItem"; // import { useSetState } from 'ahooks';
...
export default function (props) {
  ...
  let testBindingName = params.testBindingName || ''; // 获取layoutJson的本地接口
  // let layoutJsonApi = '/api/layoutJson'
  // let layoutJsonApi = `/openapi/lc/module/getAutoLayout/autoLayOut`

  let layoutJsonApi = params.layoutJsonApi || ''; // if (process.env.NODE_ENV === 'development') {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(PreviewAutoLayout, {
    api: apiPath,
    apiName: apiName,

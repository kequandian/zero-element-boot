...
export default /*#__PURE__*/forwardRef(function NamedLayout({
  ...
  const LayoutSet = layoutSet || DefaultLayoutSet; // console.log('NamedLayout.dataSource=', dataSource)
  ...
  return /*#__PURE__*/React.createElement(Layout, _extends({}, layout.props, {
    isLastItem: isLastItem,
    navigation: navigation,
    Seperator: Seperator,
    ref: ref
  }), React.Children.toArray(children).map(child => {
    let element = /*#__PURE__*/React.cloneElement(child, {

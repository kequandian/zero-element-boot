...
export default function NamedSelector(props) {
  ...
  return React.Children.map(children, child => {
    ...
    const HoverIndicator = hoverIndicator === undefined && indicator === undefined ? NextIndicator : hoverIndicator === undefined ? _IndicatorSet[hoverIndicatorName] : hoverIndicator;
    ...
    const SelectedIndicator = selectedIndicator === undefined && selector === undefined ? NextIndicator : selectedIndicator === undefined ? _IndicatorSet[selectedIndicatorName] : selectedIndicator;

...
export default function NamedCart({
  ...
  const _Indicator = _IndicatorSet[indicatorName]; // get selector

  const selectorName = typeof selector === 'string' ? selector : typeof selector === 'object' ? selector.xname : '';
  const _Selector = _IndicatorSet[selectorName]; //2021-10-28 新增 defaultIndicator 模块
  ...
  //   </_Cart>
  // </_Indicator>
  React.createElement(NamedSelector, _extends({

...
export default function NamedCart(nameCartPropsx) {
  ...
  const _CartSet = cartSet ? cartSet : DefaultCartSet(); //2021-10-28 新增 selector 模块
  ...
  const _Cart = _CartSet[cartName] || NextIndicator; // get indicator
  ...
  const _indicatorData = _indicator && _indicator.binding ? doBind(_indicator.binding, rest) : {}; // get selector
  ...
  const selectorProps = _selector && typeof _selector === 'object' ? _selector.props : {}; // 2022-11-24 defaultIndicator 更名为 unselector
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, _selector ?
  /*#__PURE__*/
  // (indicator || selector) ? only selector require OverlaySelector
  // <_Indicator {...rest}>
  //    <_Cart {...cart.props}>
  ...
  //   </_Cart>
  // </_Indicator>
  React.createElement(OverlaySelector, {
    defaultIndicator: _Unselector,
    defaultIndicatorProps: unselectorProps,
    ...
    props: cart.props,
    data: rest
  })) : _indicator ? /*#__PURE__*/React.createElement(NamedIndicator, {

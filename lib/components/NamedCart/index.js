...
export default function NamedCart(nameCartPropsx) {
  ...
  const indicatorProps = _indicator && typeof _indicator === 'object' ? {
    ...rest,
    ..._indicator.props
  } : {};
  ...
  //@what add bounding
  // get bounding
  const _bounding = typeof cart.bounding == 'string' ? {
    margin: cart.bounding
  } : cart.bounding;
  ...
  return /*#__PURE__*/React.createElement(_Bounding, {
    style: _bounding
  ...
  })) : _indicator || _selector ? /*#__PURE__*/React.createElement(_NamedSelector, {
    selector: _selector,
    selected: selected,
    __selector: __selector,
    isSelected: isSelected
  }, /*#__PURE__*/React.createElement(_NamedIndicator, {

...
function AutoLayout({
  ...
  if (isJsonObject(presenter) && presenter.presenter === undefined && presenter.children === undefined) {
    return /*#__PURE__*/React.createElement(Presenter, _extends({}, _presenter, {
  ...
  return layoutChildren ? /*#__PURE__*/React.createElement(Container, _extends({}, _container, data, {
    ...
    return /*#__PURE__*/React.createElement(__NamedGateway, _extends({}, __gateway, {
      key: i,
      span: span
    }), /*#__PURE__*/React.createElement(_NamedCart, __cart, isJsonObject(__presenter) ? /*#__PURE__*/React.createElement(__Presenter, _extends({}, __presenter, {
      allComponents: allComponents,

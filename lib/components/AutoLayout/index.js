...
import loadingPage from "../loading"; // import { Filter } from '../gateway';
...
function AutoLayout({
  ...
  const data = dataSource || rest || {}; // const data = {...dataSource, ...rest}
  // debug datasource
  ...
  if (alternativeActive) {
    ...
    } : notnull_alternative.layout ? notnull_alternative.layout : notnull_alternative; // exclude layout

    const {
      layout,
      ...alternativeOthers
    } = notnull_alternative; // alternativeBack
    ...
    }, dataSource, rest, alternativeOthers)));
  } // Cart
  ...
  const _NamedCart = cart ? NamedCart : NextIndicator; // Gateway
  ...
  const _NamedGateway = _layoutBinding || _layoutFilter || _layoutChain || _gateway ? NamedGateway : NextIndicator; // handle container
  ...
  if (!Presenter && !layoutChildren && !container) {
    ...
    const {
      ...
      _cart,
      _binding = { ..._layoutBinding
      },
      _filter = { ..._layoutFilter
      },
      _chain = { ..._layoutChain
      },
      _gateway,
    ...
    const _data_chain = _layoutChain || _chain; // all props (xname, props) from within presenter
    ...
    const __presenter = _props || {}; // selected={true} 仅用于单组件测试
    ...
    }, _rest), /*#__PURE__*/React.createElement(__NamedCart, _extends({}, _data_cart, {
      selected: true,
  ...
  return layoutChildren ? /*#__PURE__*/React.createElement(Container, _extends({}, _container, dataSource, rest, {
    ...
    return /*#__PURE__*/React.createElement(_NamedCart, _extends({
      key: i
    }, __cart), /*#__PURE__*/React.createElement(__Presenter, _extends({}, __presenter, {
      allComponents: allComponents,
      key: i,
      onItemClick: onItemClick
    })));
  ...
  }))) : /*#__PURE__*/React.createElement(Container, _extends({}, _container, dataSource, rest, {
    onItemClick: onItemClick,
    navigation: navigation,
    ...
    onItemChanged: onItemChanged,
    onItemIndicated: onItemIndicated
  }), presenter ? /*#__PURE__*/React.createElement(Presenter, _extends({}, _presenter, {
    allComponents: allComponents,
    onItemClick: onItemClick

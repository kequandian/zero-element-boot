...
function AutoLayout({
  ...
  const data = dataSource || rest || {}; // console.log('AutoLayout.container=', container)
  // Cart
  ...
  if (!layoutChildren && !container) {
    ...
    const _data_presenter = presenter || _presenter; // all props (xname, props, binding, cart, indicator) from within presenter
    ...
    const _____presenter = (_data_presenter && _data_presenter.props ? _data_presenter.props : {}) || {}; // TODO, should not support

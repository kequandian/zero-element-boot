...
const DefaultContainer = require("../container/Container"); //const CloneAutoLayout = require('@/components/CloneAutoLayout');
// const AutoComponent = require('@/components/AutoComponent');


import { get as NamedPresenterGet } from "../config/NamedPresenterConfig"; // import fetchLayout from '@/components/utils/fetchLayout';

import loadingPage from "../loading"; // import AutoComponent  from '@/components/AutoComponent';
...
function AutoLayout({
  ...
  console.log('layoutChildren ===== 1111', layoutChildren); // AutoComponent config
  ...
  return layoutChildren ? /*#__PURE__*/React.createElement(_Container, _extends({}, _container, data, {
    ...
    console.log('_AutoComponent allComponents = ', allComponents); // const _gateway = gateway ? ((typeof gateway === 'string') ? { xname: gateway } : gateway) : defaultGateway
    // const _cart = cart ? ((typeof cart === 'string') ? { xname: cart } : cart) : defaultCart
    ...
    if (typeof presenter === 'string') {
      ...
      return /*#__PURE__*/React.createElement(NamedGateway, _extends({}, _gateway, {
        key: i,
        span: span
      }), cart ? /*#__PURE__*/React.createElement(NamedCart, _cart, presenter ? /*#__PURE__*/React.createElement(Presenter, null) : React.Children.toArray(children)) : presenter ? /*#__PURE__*/React.createElement(Presenter, null) : React.Children.toArray(children));
    } else if (isJsonObject(presenter)) {
      return /*#__PURE__*/React.createElement(NamedGateway, _extends({}, _gateway, {
        key: i,
        span: span
      }), presenter ? /*#__PURE__*/React.createElement(AutoLayout, {
        layout: presenter,
...
function _AutoComponent({
  ...
  */
  ...
  return /*#__PURE__*/React.createElement(_Container, _extends({}, _container, data, {
    navigation: navigation
  }), cart ? /*#__PURE__*/React.createElement(NamedLayout, {
    xname: xname,
    props: props,

...
function AutoLayout({
  ...
  const Presenter = presenter ? typeof presenter === 'string' ? allComponents[presenter] : presenter.children ? _AutoComponent({ ...presenter.children,
    ...data
  }) : isJsonObject(presenter) ? AutoLayout : tips(presenter) : null;
  console.log('allComponents ===== ', allComponents);
  console.log('presenter ===== ', presenter); //如 presenter 为 object，则封装到 layout

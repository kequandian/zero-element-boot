...
export default function Index(props) {
  ...
  const [layoutRef, {
    getClassName
  }] = useLayout(); // const { children, items = [], currentTabIndex = 0, onSwitchTab, isSwitch, cb } = props;
  ...
  const Child = React.Children.only(children); // useEffect(() => {
  //     console.log('加载')
  //     setTabIndex(0)
  // }, [items]);
  //tab切换
  ...
  })), /*#__PURE__*/React.createElement(TabPanels, null, items.map((item, index) => /*#__PURE__*/React.createElement(TabPanel, {
    key: `${index}_tabPanel`
  }, isLoading ? /*#__PURE__*/React.createElement(Spinner, null) : /*#__PURE__*/React.createElement(Box, null, React.Children.map(children, child => {

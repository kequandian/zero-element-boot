...
export default function AddNewContainer(props) {
  ...
  const addNewData = data => {
    ...
    promiseAjax(addnewApi, queryData, {
      method: 'POST'
    }).then(resp => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !onFirstRefresh && childList[0] ? /*#__PURE__*/React.isValidElement(childList[0]) ? ( /*#__PURE__*/React.cloneElement(childList[0], {
    ...rest,
    onItemClick: firstChildItemClick,
    onAddNewClick: firstChildAddNew,
    onItemDeleted: firstChildDelete
  })) : /*#__PURE__*/React.createElement(React.Fragment, null) : /*#__PURE__*/React.createElement(React.Fragment, null), !onSecondRefresh && childList[1] ? /*#__PURE__*/React.isValidElement(childList[1]) ? ( /*#__PURE__*/React.cloneElement(childList[1], {
    ...itemData,

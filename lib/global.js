...
import ShadowIndicator from "./components/indicator/ShadowIndicator"; // import CircularCheckboxIndicatorSelected from '@/components/indicator/CircularCheckboxIndicator/CircularCheckboxSelected';
...
import BackIndicator from "./components/indicator/BackIndicator"; //presenter
...
const {
  TableCompx
} = require("./presenter/demo"); // SelectListDemo
//indicator
...
import SelectedCartRightIcon from "./components/indicator/SelectedCartRightIcon"; //presenter

import { Clean, Butter, Pink, Clear } from "./components/presenter";
...
import TagIndicator from "./components/indicator/TagIndicator"; // NamedCartSet({
// })
...
if (process.env.NODE_ENV == 'development') {
  ...
  setEndpoint('http://static.smallsaas.cn'); // setToken('eyJ0eXBlIjoiSldUIiwiYWxnIjoiSFM1MTIifQ.eyJvcmdJZCI6MzAsInVzZXJJZCI6MzE4LCJhY2NvdW50IjoiYjQxYTg2OTRhNjM4NDIyNWJmNWMxOTQyZjdmZjIyNTYiLCJkb21haW5Vc2VySWQiOiIiLCJ0eXBlIjoxNDYxLCJpYXQiOjE2NjkxMTMzMTQsImp0aSI6IjMxOCIsInN1YiI6ImI0MWE4Njk0YTYzODQyMjViZjVjMTk0MmY3ZmYyMjU2IiwiZXhwIjoxNjY5MzcyNTE0fQ.HnIuikkC0ugUeZAoqhtVgl4wYiJUgkuL9v8kd46YNIBpdCj-DujDVfHIUgfCqjp0mP23o-3hP697swHrP2qPiQ')
}

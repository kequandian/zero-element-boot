        ...
        <NamedLayout xname={xname} props={props} >
          {layoutChildren ? layoutChildren.map((child, i) => {
            ...
            if(typeof presenter === 'string'){
              presenterString({children, presenter, defaultPresenter, gateway, defaultGateway, cart, defaultCart, span, componentsJson }, i);
            }else if(typeof presenter === 'object'){
...
function presenterString(props, i){
  const {children, presenter, defaultPresenter, gateway, defaultGateway, cart, defaultCart, span, componentsJson } = props;
  const _presenter = presenter ? presenter : defaultPresenter
  const Presenter = _presenter ? componentsJson[_presenter] || tips(_presenter) : null;

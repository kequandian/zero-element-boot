...
export default function Index(props) {
    ...
    const { children, action, indicatorData } = props;
    ...
    return (
        <div style={{width:'100%'}}>
            <Flex>  
                ...
                <Button isLoading={loading} colorScheme='teal' variant='link' onClick={() => onDownlaod()} alignItems='center'>
                    <CssCart width='20px' margin='auto 6px '>
                        <svg t="1669881466959" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2339" width="20" height="20">
